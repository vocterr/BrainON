...
export default function AboutMePage() {
    ...
    // ===== NOWA, OSTATECZNA I PRAWDZIWA HISTORIA =====
    ...
    return (
        <div className="w-full bg-slate-900 text-white font-chewy">
            ...
            {/* ===== SEKCJA: MOJA HISTORIA (ZMIENIONA ZGODNIE Z PRAWDĄ) ===== */}
            ...
            {/* ===== SEKCJA: MOJA FILOZOFIA (BEZ ZMIAN) ===== */}
            <section className="py-20 sm:py-32 px-4">
                ...
                >
                    ...
                    <motion.p variants={itemVariants} className="text-purple-200/70 font-sans text-lg max-w-2xl text-center mb-16">Oto 3 filary, na których opiera się każda nasza lekcja.</motion.p>
            ...
            <section className="py-20 sm:py-32 px-4">
                ...
                >
                    ...
                    <motion.button onClick={() => changeRoute("/")} whileHover={{ scale: 1.05, boxShadow: "0px 10px 30px -10px rgba(251, 191, 36, 0.5)" }} whileTap={{ scale: 0.95 }} className="flex items-center gap-2 px-8 py-4 rounded-full bg-gradient-to-r from-yellow-400 via-orange-500 to-orange-600 text-white text-xl shadow-lg mx-auto">
                        Wybierz przedmiot <FiArrowRight />
                    </motion.button>
                </motion.div>
            </section>
        </div>
