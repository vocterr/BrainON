...
// 1. useParams jest już zaimportowany - świetnie!
import { useParams } from 'next/navigation';
import { useState, useEffect } from 'react';
import { motion } from 'framer-motion';
import { FiMapPin, FiMonitor, FiHome, FiArrowRight, FiLoader, FiLogIn, FiDivideCircle, FiCode } from 'react-icons/fi';
...
// 2. Ten typ nie jest już potrzebny, ponieważ nie przekazujemy 'params' jako props.
...
// 3. Usuwamy 'params' z propsów funkcji.
export default function WybierzTerminPage() {
    const router = useRouter();
    const { data: session } = useSession();

    // 4. Używamy hooka useParams() do pobrania parametrów z URL.
    const params = useParams();
    // Upewniamy się, że 'details' jest stringiem.
        ...
        <main className="w-full min-h-screen relative bg-slate-900 text-white font-chewy overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-4 py-16 sm:py-24 relative z-10">
                ...
                <div className="grid lg:grid-cols-5 gap-8 items-start">
                    <motion.div initial={{ opacity: 0}} animate={{opacity: 1}} transition={{staggerChildren: 0.1}} className="lg:col-span-3 flex flex-col gap-8">
